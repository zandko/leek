...
export function setupSwagger(app: INestApplication, configure: ConfigureAdapter): void {
  const documentBuilder = new DocumentBuilder().setTitle('Leek API').setDescription(
    `### REST
...
**Creation / Edition / Replacement / Suppression:**
  ...
  console.info(`Documentation: http://localhost:${configure.PORT}/documentation`);
}
